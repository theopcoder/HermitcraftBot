    ...
    async run(message, args)
    {
        let RankUser = message.guild.member(message.mentions.users.first());
        {
            ...
            {   
                ...
                .addField("Level: ", db.get(`{Level}_${message.mentions.users.first().id}`))
                .addField("XP: ", db.get(`{xp}_${message.mentions.users.first().id}`))
            ...
            else
            {
                ...
                .addField("XP: ", db.get(`{xp}_${message.author.id}`))
